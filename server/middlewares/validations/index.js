...
function userRegistrationRules() {
  return [
    body("firstname", "Firstname cannot be empty").isLength({
      min: 2,
      max: 30,
    }),
    ...
    body(
      "password",
      "Password should be minimum 8 characters 1 Uppercase and 1 Lowercase and one special symbol  "
    ).isStrongPassword({
      minLength: 8,
      minLowercase: 1,
      minUppercase: 1,
...
export { newTaskValidationRules, userRegistrationRules, errorMiddleware , userLoginRules};
